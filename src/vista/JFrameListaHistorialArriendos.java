 ...
 * nombre: FFrameListaHistoriaArriendos
 * Su función lista historial de arriendos
 * entrada null
 * salida null
 ...
 */
public class JFrameListaHistorialArriendos extends javax.swing.JFrame {
    ...
    public JFrameListaHistorialArriendos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" < LISTADO DE LIBROS EN ARRIENDO > ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameListaHistorialArriendos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameListaHistorialArriendos().setVisible(true);
            }
        });
    }
